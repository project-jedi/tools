unit QuerySiteInfoStatisticsMainUnit;
...
type
  ...
  private
    ...
    procedure MediaWikiSiteInfoStatisticsDone(Sender: TMediaWikiApi; Infos: TStrings);
  public
  end;
...
begin
  ...
  FMediaWikiApi.OnQuerySiteInfoStatisticsDone := MediaWikiSiteInfoStatisticsDone;
  FMediaWikiApi.QueryInit;
  FMediaWikiApi.QuerySiteInfoStatisticsAsync;
...
begin
  MemoResult.Lines.Clear;
  FMediaWikiApi.OnQuerySiteInfoStatisticsDone := nil;
  FMediaWikiApi.QuerySiteInfoStatistics(MemoResult.Lines);
end;
...
procedure TMainForm.MediaWikiSiteInfoStatisticsDone(Sender: TMediaWikiApi; Infos: TStrings);
begin
