unit QuerySiteInfoSpecialPageAliasesMainUnit;
...
type
  ...
  private
    ...
    procedure MediaWikiSiteInfoSpecialPageAliasesDone(Sender: TMediaWikiApi; Infos: TStrings);
  public
  end;
...
begin
  ...
  FMediaWikiApi.OnQuerySiteInfoSpecialPageAliasesDone := MediaWikiSiteInfoSpecialPageAliasesDone;
  FMediaWikiApi.QueryInit;
  FMediaWikiApi.QuerySiteInfoSpecialPageAliasesAsync;
...
begin
  MemoResult.Lines.Clear;
  FMediaWikiApi.OnQuerySiteInfoSpecialPageAliasesDone := nil;
  FMediaWikiApi.QuerySiteInfoSpecialPageAliases(MemoResult.Lines);
end;
...
procedure TMainForm.MediaWikiSiteInfoSpecialPageAliasesDone(Sender: TMediaWikiApi; Infos: TStrings);
begin
